...
const Skills = () => {
  return (
    ...
    <div className='main'>
        ...
        <h3 className="para">I'm a second-year ECE student passionate about Coding, Competitive Programming and Web Development. Currently, I'm exploring web development to create innovative projects that blend technology and creativity, showcasing my skills and interests.</h3>
